...
import { CO2AbsorptionController } from '../presentation/controllers/CO2AbsorptionController';
...
const co2AbsorptionController = new CO2AbsorptionController(
  co2AbsorptionService,
  forestService,
);
co2AbsorptionController.registerRoutes(app);
